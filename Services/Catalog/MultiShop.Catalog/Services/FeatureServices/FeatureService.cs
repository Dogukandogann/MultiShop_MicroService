...
namespace MultiShop.Catalog.Services.FeatureServices
{
    public class FeatureService : IFeatureService
    {
        ...
        {
            await _featureCollection.DeleteOneAsync(x=>x.FeatureId.Equals(id));
        }
        ...
        {
            var value = await _featureCollection.Find(x=>x.FeatureId.Equals(id)).FirstOrDefaultAsync();
        ...
        public async Task UpdateFeatureAsync(UpdateFeatureDto updateFeatureDto)
        {
            ...
            await _featureCollection.FindOneAndReplaceAsync(x=>x.FeatureId.Equals(updateFeatureDto.FeatureId),value);
        }
    }
}
